...
//   return (
//     <section className="h-screen flex items-center relative bg-white py-12 sm:py-16 lg:py-20 overflow-hidden">
...
//             <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gradient-to-r from-gray-900 to-gray-800 leading-tight mb-7 ml-10 mt-8">
//               Unlock Capital, Accelerate <br className="hidden sm:inline" />
//               <span className="text-green-400">Sustainability</span>
//             </h1>

//             <p className="mt-4 text-lg sm:text-xl text-gray-700 max-w-2xl mb-10 ml-10">
//               Liquidate & Procure Excess Manufacturing Inventory with Ease.
//               Connect with a Global Network of Manufacturers and Buyers.
//             </p>

//             <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-4 mb-12 ml-10">
//               <button
//                 className="w-full sm:w-auto px-8 py-3 text-lg font-semibold rounded-lg shadow-lg shadow-green-500/20 hover:shadow-xl hover:shadow-green-500/30 transition-all duration-300 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 text-white border-0"
...
//         {/* Search Bar */}
//         <div className="mt-5 max-w-2xl mr-1">
//           <div className="bg-white border border-gray-300 shadow-md p-2 rounded-full flex items-center">
//             <input
//               type="text"
//               placeholder="Type Part Number, Category, or Keyword..."
//               className="flex-grow border-none outline-none px-4 py-3 text-gray-800 placeholder:text-gray-400 bg-transparent rounded-l-full"
//               aria-label="Search inventory"
//             />
//             <button
//               className="px-6 py-3 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 text-white rounded-full transition-all duration-200 font-semibold shadow-lg shadow-green-500/20"
//               aria-label="Search"
    ...
    <section className="h-screen flex items-center relative bg-white py-12 sm:py-16 lg:py-20 overflow-hidden">
      ...
      <div className="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-18 items-center">
          ...
          {/* Left Content */}
          <div className="text-left -mt-8 lg:-mt-12">
            <h1 className="no-underline text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-700 leading-tight mb-7 ml-10 mt-8">
              Unlock Capital, Accelerate <br className="hidden sm:inline" />
              <span className="no-underline text-green-400">Sustainability</span>
            </h1>

            <p className="no-underline mt-4 text-lg sm:text-xl text-gray-700 max-w-2xl mb-10 ml-10">
              Liquidate & Procure Excess Manufacturing Inventory with Ease. 
              Connect with a Global Network of Manufacturers and Buyers.
            </p>
        ...
        <div className=" max-w-2xl mr-1">
          <div className="bg-white border border-gray-300 shadow-md rounded-full flex items-center">
            <input
              type="text"
              placeholder="Type Part Number, Category, or Keyword..."
              value={searchQuery}
              ...
              className="flex-grow border-none outline-none text-gray-800 placeholder:text-gray-400 bg-transparent rounded-l-full"
              aria-label="Search inventory"
            />
            <button
              className="px-6 py-3 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 text-white rounded-full transition-all duration-200 font-semibold shadow-lg shadow-green-500/20"

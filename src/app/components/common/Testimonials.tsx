...
const Testimonials: React.FC = () => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-r from-green-100 to-white py-20 font-inter">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
          {stats.map((stat, index) => (
            <div key={index} className="text-center p-4 bg-gradient-to-br from-purple-100 via-gray-100 to-purple-200 rounded-xl shadow-lg border border-green-500/20 hover:border-green-500/30 transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial: Testimonial, index: number) => (
            <Card 
              key={testimonial.id} 
              className="group relative overflow-hidden bg-gradient-to-br from-purple-100 via-gray-100 to-purple-200 border border-green-500/20 hover:border-green-500/30 transition-all duration-300 hover:shadow-xl hover:shadow-green-500/20 flex flex-col justify-between rounded-xl"
            >
              {/* Top accent */}
              <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-green-400 to-green-600"></div>
              ...
              <CardContent className="p-6 flex flex-col h-full">
                ...
                <div className="flex-grow mb-6">
                  ...
                  <p className="text-lg text-gray-700 italic mb-4 leading-relaxed group-hover:text-gray-800 transition-colors duration-300">
                    {testimonial.quote}
                  </p>
                ...
                <div className="border-t border-gray-300/50 pt-4">
                  <div className="flex items-center mb-3">
                    ...
                    <div className="flex-grow">
                      <p className="font-bold text-gray-800 group-hover:text-gray-900 transition-colors duration-300">
                        {testimonial.author}
                      </p>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-green-800 bg-green-500/20 px-2 py-1 rounded-full border border-green-500/30">
                        {testimonial.industry}
                      </span>

...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '../../../components/ui/select';
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '../../../components/ui/table';
import { BarChart2, LineChart, PieChart, Users, DollarSign, Package, TrendingUp, Download, Activity, CheckCircle } from 'lucide-react';
import AdminSidebar from '../../../components/AdminSidebar';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-green-100 to-white flex font-inter">
      ...
      <div className="flex-1 p-6 space-y-8">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gradient-to-br from-gray-900 via-gray-800 to-gray-900 mb-2">Platform Analytics</h1>
            <p className="text-gray-800 text-base">Comprehensive insights into platform performance, user engagement, and market trends.</p>
          </div>
          <div className="flex items-center space-x-4">
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <Select defaultValue="last30days">
              <SelectTrigger className="w-[180px] bg-white border-green-500/30 text-gray-900 rounded-lg">
                <SelectValue placeholder="Select period" />
              </SelectTrigger>
          ...
          <Button 
            className="bg-green-500 hover:bg-green-600 text-white rounded-lg py-3 text-sm font-medium transition-all" 
            onClick={() => handleDownloadAnalytics('Platform Analytics')}
          >
            <Download className="h-4 w-4 mr-2" /> Export Analytics Data
          </Button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-gradient-to-br from-purple-100 via-gray-100 to-purple-200 border-slate-700 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-slate-750">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-gray-700 mb-1">{overviewStats.totalUsers}</div>
              <p className="text-xs text-gray-700">Active: {overviewStats.activeUsers}</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-purple-100 via-gray-100 to-purple-200 border-slate-700 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-slate-750">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-gray-700 mb-1">{overviewStats.totalRevenue}</div>
              <p className="text-xs text-gray-700">{overviewStats.revenueGrowth}</p>
            </CardContent>
          </Card>
          
          <Card className="bg-gradient-to-br from-purple-100 via-gray-100 to-purple-200 border-slate-700 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-slate-750">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-bold text-gray-900">Active Listings</CardTitle>
              <Package className="h-6 w-6 text-green-500" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-gray-700 mb-1">{overviewStats.activeListings}</div>
              <p className="text-xs text-gray-700">{overviewStats.listingsGrowth}</p>
            </CardContent>
          </Card>

          <Card className="bg-gradient-to-br from-purple-100 via-gray-100 to-purple-200 border-slate-700 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-slate-750">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-bold text-gray-900">Avg. Transaction Value</CardTitle>
              <TrendingUp className="h-6 w-6 text-lime-400" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-gray-700 mb-1">{overviewStats.avgTransactionValue}</div>
              <p className="text-xs text-gray-700">{overviewStats.transactionStatus}</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="bg-gradient-to-br from-purple-100 via-gray-100 to-purple-200 border-green-500/20 rounded-xl shadow-lg p-6 hover:border-green-500/30 transition-all">
            ...
            <div className="bg-white rounded-lg p-6">
              <div className="h-64 flex items-center justify-center text-gray-400 border-2 border-dashed border-green-500/30 rounded-lg">
                <div className="text-center">
                  <LineChart className="h-12 w-12 mx-auto mb-2 text-green-600" />
                  <p className="text-sm text-gray-700">Line Chart: New User Registrations</p>
                  <p className="text-xs text-gray-600 mt-1">Monthly growth trend visualization</p>
                </div>
              </div>
            </div>
            <div className="pt-4">
              <Button 
                className="w-full justify-start bg-green-500 hover:bg-green-600 text-white rounded-lg py-3 text-sm font-medium transition-all" 
                onClick={() => handleDownloadAnalytics('User Registration Trend')}
              >
                <Download className="h-4 w-4 mr-2" /> Download Trend Report
              </Button>
            ...
            <div className="bg-white rounded-lg p-6">
              <div className="h-64 flex items-center justify-center text-gray-400 border-2 border-dashed border-green-500/30 rounded-lg">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-700">Bar Chart: Transactions per Month</p>
                  <p className="text-xs text-gray-600 mt-1">Volume analysis and trends</p>
                </div>
              </div>
            </div>
            <div className="pt-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="bg-gradient-to-br from-purple-100 via-gray-100 to-purple-200 border-green-500/20 rounded-xl shadow-lg p-6 hover:border-green-500/30 transition-all">
            ...
            <div className="bg-white rounded-lg p-6">
              <div className="h-64 flex items-center justify-center text-gray-400 border-2 border-dashed border-green-500/30 rounded-lg">
                <div className="text-center">
                  <PieChart className="h-12 w-12 mx-auto mb-2 text-green-600" />
                  <p className="text-sm text-gray-700">Pie Chart: Category Distribution</p>
                  <p className="text-xs text-gray-600 mt-1">Listing and sales breakdown</p>
                </div>
              </div>
            </div>
            <div className="pt-4">
          ...
          <Card className="bg-gradient-to-br from-purple-100 via-gray-100 to-purple-200 border-slate-700 rounded-xl shadow-lg p-6">
            <CardTitle className="text-lg font-semibold text-gray-900 mb-4">Performance Metrics</CardTitle>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-white hover:bg-slate-800/50">
                    ...
                    <TableHead className="text-gray-900 font-semibold text-right">Value</TableHead>
                    <TableHead className="text-gray-900 font-semibold text-right">Change</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  <TableRow className="border-slate-700 hover:bg-slate-800/50 transition-colors">
                    <TableCell className="font-medium text-gray-700 text-sm">Page Views</TableCell>
                    <TableCell className="text-gray-700 text-sm text-right tabular-nums font-semibold">45,239</TableCell>
                    <TableCell className="text-green-600 text-sm text-right tabular-nums">+12%</TableCell>
                  </TableRow>
                  <TableRow className="border-slate-700 hover:bg-slate-800/50 transition-colors">
                    <TableCell className="font-medium text-gray-700 text-sm">Session Duration</TableCell>
                    <TableCell className="text-gray-700 text-sm text-right tabular-nums font-semibold">8:45 min</TableCell>
                    <TableCell className="text-green-600 text-sm text-right tabular-nums">+5%</TableCell>
                  </TableRow>
                  <TableRow className="border-slate-700 hover:bg-slate-800/50 transition-colors">
                    <TableCell className="font-medium text-gray-700 text-sm">Bounce Rate</TableCell>
                    <TableCell className="text-gray-700 text-sm text-right tabular-nums font-semibold">32.4%</TableCell>
                    <TableCell className="text-red-600 text-sm text-right tabular-nums">-3%</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </div>
        ...
        <Card className="bg-gradient-to-br from-purple-100 via-gray-100 to-purple-200 border-green-500/20 rounded-xl shadow-lg p-6 hover:border-green-500/30 transition-all">
                ...
                <li key={log.id} className="flex items-start p-3 rounded-lg hover:bg-slate-750 border border-green-500/10 hover:border-green-500/20 transition-all">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-gray-700">
                      <span className="text-green-700">{log.type}</span>: <span className="text-gray-800">{log.user}</span>
                    </p>
                    <p className="text-gray-700 text-sm mt-1">{log.details}</p>
                    <p className="text-xs text-green-900 mt-1">{log.timestamp}</p>
                  </div>
                  <Activity className="h-4 w-4 text-green-600 flex-shrink-0 mt-1" />
                </li>
              ))}
            </ul>
          </div>
          <div className="pt-4">
            <Button 
              className="bg-green-500 hover:bg-green-600 text-white rounded-lg py-3 px-4 text-sm font-medium transition-all" 
              onClick={() => handleDownloadAnalytics('Activity Analytics')}
            >
              <Download className="h-4 w-4 mr-2" /> Download Activity Analytics
            </Button>

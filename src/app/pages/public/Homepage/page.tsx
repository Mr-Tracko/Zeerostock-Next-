...
const HomePage: React.FC = () => {
  ...
  //           </h2>
  //           <p className="text-lg text-gradient-to-br from-gray-900 via-gray-800 to-gray-900 max-w-3xl mx-auto">
  ...
  //             <div
  //               key={index}
  //               className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 backdrop-blur-sm p-6 rounded-xl border border-gray-700/50 hover:border-green-400/50 transition-all duration-300"
  //             >
  ...
  //             <div
  //               key={index}
  //               className="group relative bg-gray-800/40 backdrop-blur-sm p-6 rounded-xl border border-gray-700/50 hover:border-white/70 hover:bg-white/10 transition-all duration-300 hover:shadow-2xl hover:shadow-white/30 cursor-pointer"
  //             >
  //               <div className="absolute top-2 right-2 w-3 h-3 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:animate-pulse" />
  ...
  //                 <div className="w-16 h-16 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-xl flex items-center justify-center border border-green-400/30 group-hover:scale-110 transition-transform duration-300">
  //                   <span className="text-white font-bold text-sm group-hover:text-green-100 transition-colors duration-300">
  //                     {company.logo}
  //                   </span>
  //                 </div>
  //                 <div className="text-center">
  //                   <h3 className="text-gradient-to-br from-gray-900 via-gray-800 to-gray-900 font-semibold text-sm group-hover:text-green-400 transition-colors duration-300 mb-1">
  //                     {company.name}
  //                   </h3>
  //                   <p className="text-xs text-gray-800 group-hover:text-gradient-to-br from-gray-900 via-gray-800 to-gray-900 transition-colors duration-300">
  //                     {company.industry}
  //                   </p>
  //                 </div>
  //               </div>

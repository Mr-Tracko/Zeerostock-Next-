  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-green-100 to-white flex font-inter">
      ...
      <div className="flex-1 p-6 space-y-8">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gradient-to-br from-gray-900 via-gray-800 to-gray-900 mb-2">Seller Dashboard</h1>
            <p className="text-gray-800 text-base">Welcome back, manage your inventory and track performance.</p>
          </div>
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              <Button
                variant="outline"
                className="flex items-center bg-white border-green-500 text-gray-800 hover:bg-green-50 hover:border-green-600"
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                Quick Actions <ChevronDown className="ml-2 h-4 w-4" />
              </Button>
              {dropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg z-10">
                  <button
                    ...
                    className="w-full px-4 py-2 text-left text-gray-800 hover:bg-green-50 flex items-center transition-colors"
                  >
                    <Plus className="mr-2 h-4 w-4" />
                    List New Item
                  </button>
                  <button
                    ...
                    className="w-full px-4 py-2 text-left text-gray-800 hover:bg-green-50 flex items-center"
                  >
                    <Gavel className="mr-2 h-4 w-4" />
                    View Offers
                  </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="bg-gradient-to-br from-purple-100 via-gray-100 to-purple-200 border-green-500/20 rounded-xl shadow-lg p-6 hover:border-green-500/30 transition-all">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="relative">
                <Button
                  variant="outline"
                  className="flex items-center bg-white border-gray-200 text-gray-800 hover:bg-green-50 hover:border-green-500/50"
                  onClick={() => setChartDropdownOpen(!chartDropdownOpen)}
                >
                  Last 30 days <ChevronDown className="ml-2 h-4 w-4" />
                </Button>
                  ...
                  <div className="absolute right-0 mt-2 w-32 bg-white border border-gray-200 rounded-md shadow-lg z-10">
                    {chartPeriods.map((period: string) => (
                      <button
                        key={period}
                        onClick={() => setChartDropdownOpen(false)}
                        className="w-full px-3 py-2 text-left text-gray-800 hover:bg-green-50 text-sm transition-colors"
                      >
                        {period}
                      </button>
                    ))}
            ...
            <div className="h-64 flex items-center justify-center text-gray-600 bg-white rounded-lg border border-green-500/10">
              <div className="text-center">
                <p className="text-sm mb-5">Sales Performance Chart</p>
                <img
                  src="/graph1.png"
          ...
          <Card className="bg-gradient-to-br from-purple-100 via-gray-100 to-purple-200 border-slate-700 rounded-xl shadow-lg p-6">
            <div className="flex justify-between items-center mb-6">
              <CardTitle className="text-lg font-semibold text-gray-700">Category Performance</CardTitle>
              <Button
                variant="link"
        ...
        <Card className="bg-gradient-to-br from-purple-100 via-gray-100 to-purple-200 border-slate-700 rounded-xl shadow-lg p-6">
          <div className="flex justify-between items-center mb-4">
            <CardTitle className="text-lg font-semibold text-gray-700">Active Listings</CardTitle>
            <div className="flex space-x-3">
              <Button
                variant="outline"
                onClick={() => handleNavigation('/seller/manage-listings')}
                className="bg-white border-gray-200 text-gray-800 hover:bg-green-50 hover:border-green-500"
              >
                <Eye className="h-4 w-4 mr-2" /> View All
              </Button>
              <Button
                className="bg-green-600 hover:bg-green-700 text-white shadow-lg hover:shadow-green-500/25 transition-all duration-200"
                onClick={() => handleNavigation('/seller/list-new-item')}
              >
                <Plus className="h-4 w-4 mr-2" /> Add New
              </Button>
              ...
              <TableBody>
                {activeListings.map((listing: Listing) => (
                  <TableRow key={listing.id} className="border-slate-700 hover:bg-slate-800/50">
                    <TableCell className="font-medium text-gray-700">{listing.product}</TableCell>
                    <TableCell className="text-gray-700 text-sm">{listing.category}</TableCell>
                    <TableCell className="text-gray-700 text-sm font-semibold">{listing.price}</TableCell>
                    <TableCell className="text-gray-700 text-sm">{listing.stock}</TableCell>
                    <TableCell>
                      <span className={`px-3 py-1 rounded-full text-xs font-semibold ${listing.status === 'Active'
                    ...
                    <TableCell className="text-right">
                      <div className="flex justify-end space-x-1">
                        <Button
                          variant="ghost"
                          size="icon"
                          className="mr-1 hover:bg-green-50 text-gray-400 hover:text-green-600"
                          onClick={() => handleNavigation(`/seller/edit-listing/${listing.id}`)}
                        >
                          <Edit className="h-4 w-4" />
                        </Button>

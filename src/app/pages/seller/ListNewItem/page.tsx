      ...
      <div className="flex-1 p-6">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-gradient-to-br from-gray-900 via-gray-800 to-gray-900 mb-2">List New Item</h1>
              <p className="text-gray-800 text-base">Guide to listing your excess manufacturing inventory.</p>
            </div>
              ...
              <div className="mb-8">
                <div className="flex items-center justify-between mb-4">
                  {[1, 2, 3, 4].map((step) => (
                    <div key={step} className="flex flex-col items-center">
                      ...
                      <span className={`text-xs mt-2 text-center max-w-[80px] ${step <= currentStep ? 'text-green-600' : 'text-gray-600'
                        }`}>
                        {stepTitles[step - 1]}
                      </span>
                    </div>
                ...
                {currentStep === 1 && (
                  <div className="space-y-6 mt-8">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="itemName" className="text-gray-800 font-medium">Item Name</Label>
                      <Input
                        id="itemName"
                        type="text"
                        placeholder="e.g., Steel Copper etc.."
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={formData.category} onValueChange={(value) => handleSelectChange(value, 'category')}>
                        <SelectTrigger id="category" className="bg-white border-gray-300 text-gray-900 focus:border-green-500 focus:ring-green-500">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <Label htmlFor="condition" className="text-gray-800 font-medium">Condition</Label>
                        <Select value={formData.condition} onValueChange={(value) => handleSelectChange(value, 'condition')}>
                          <SelectTrigger id="condition" className="bg-white border-gray-300 text-gray-900 focus:border-green-500 focus:ring-green-500">
                            <SelectValue placeholder="Select condition" className="text-gray-500" />
                          </SelectTrigger>
                          <SelectContent className="bg-white border-gray-300">
                            {conditions.map(cond => (
                              <SelectItem key={cond} value={cond.toLowerCase().replace(/\s/g, '-')} className="text-gray-900 hover:bg-gray-100">
                                {cond}
                              </SelectItem>
                            ))}
                          </SelectContent>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex space-x-2">
                          <Input
                            ...
                            onChange={handleInputChange}
                            required
                            className="bg-white border-gray-300 text-gray-900 placeholder-gray-500 focus:border-green-500 focus:ring-green-500 flex-grow"
                          />
                          <Select value={formData.unit} onValueChange={(value) => handleSelectChange(value, 'unit')}>
                            <SelectTrigger id="unit" className="w-[100px] bg-white border-gray-300 text-gray-900 focus:border-green-500 focus:ring-green-500">
                              <SelectValue placeholder="units" />
                            </SelectTrigger>
                            <SelectContent className="bg-white border-gray-300">
                              {units.map(unit => (
                                <SelectItem key={unit} value={unit} className="text-gray-900 hover:bg-gray-100">
                                  {unit}
                                </SelectItem>
                              ))}
                            </SelectContent>
                ...
                {currentStep === 2 && (
                  <div className="space-y-6 mt-8">
                    <h3 className="text-xl font-semibold text-gray-900 flex items-center">
                      <Camera className="h-5 w-5 mr-2 text-green-400" /> Detailed Specifications & Media
                    </h3>
                    <div className="space-y-2">
                      <Label htmlFor="dimensions" className="text-gray-800 font-medium">Dimensions</Label>
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="weight" className="text-gray-800 font-medium">Weight</Label>
                      <span className='text-green-600 text-sm'>(optional)</span>
                      <Input
                        id="weight"
                        type="text"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="certifications" className="text-gray-800 font-medium">Certifications / Standards</Label>
                      <span className='text-green-600 text-sm'>(optional)</span>
                      <Input
                        id="certifications"
                        type="text"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="images" className="text-gray-800 font-medium">Product Images / Videos</Label>
                      <Input
                        id="images"
                        type="file"
                        multiple
                        onChange={handleImageUpload}
                        className="bg-white border-gray-300 text-gray-900 file:bg-green-600 file:text-white file:border-0 file:rounded-md file:mr-4 file:py-2 file:px-4 hover:file:bg-green-700"
                      />
                      <div className="flex flex-wrap gap-2 mt-2">
                        {formData.images.map((img, index) => (
                          <div key={index} className="relative">
                            <img src={img.url} alt={`Uploaded ${img.name}`} className="h-24 w-24 object-cover rounded-md border border-gray-300" />
                            <Button
                              variant="destructive"
                              size="icon"
                              className="absolute top-0 right-0 h-6 w-6 rounded-full -mt-2 -mr-2 bg-red-600 hover:bg-red-700"
                      ...
                      <p className="text-xs text-gray-600">Upload high-quality images or short videos of your product.</p>
                    </div>
                    <div className="flex justify-between mt-8">
                      <Button
                        variant="outline"
                        onClick={handleBack}
                        className="border-green-600 text-green-600 hover:bg-green-600 hover:text-white py-2 px-6 transition-all duration-300"
                      >
                        Back
                      </Button>
                      <Button
                ...
                {currentStep === 3 && (
                  <div className="space-y-6 mt-8">
                    ...
                    <div className="space-y-2">
                      <Label className="text-gray-800 font-medium">Pricing Option</Label>
                      <RadioGroup value={formData.pricingOption} onValueChange={(value: PricingOption) => handleSelectChange(value, 'pricingOption')} className="flex space-x-4">
                        <Label htmlFor="fixed" className="flex items-center space-x-2 cursor-pointer text-gray-800 hover:text-gray-900">
                          <RadioGroupItem value="fixed" id="fixed" className="text-green-500 border-gray-400" />
                          <span>Fixed Price</span>
                        </Label>
                        <Label htmlFor="minimum" className="flex items-center space-x-2 cursor-pointer text-gray-800 hover:text-gray-900">
                          <RadioGroupItem value="minimum" id="minimum" className="text-green-500 border-gray-400" />
                          <span>Minimum Price (Negotiable)</span>
                        </Label>
                        <Label htmlFor="auction" className="flex items-center space-x-2 cursor-pointer text-gray-800 hover:text-gray-900">
                          <RadioGroupItem value="auction" id="auction" className="text-green-500 border-gray-400" />
                          <span>Auction</span>
                        </Label>
                      </RadioGroup>
                    </div>
                    ...
                    {formData.pricingOption === 'fixed' && (
                      <div className="space-y-2">
                        <Label htmlFor="fixedPrice" className="text-gray-800 font-medium">Fixed Price (INR)</Label>
                        <Input
                          id="fixedPrice"
                          type="number"
                          placeholder="e.g., 55000"
                    ...
                    {formData.pricingOption === 'minimum' && (
                      <div className="space-y-2">
                        <Label htmlFor="minimumPrice" className="text-gray-800 font-medium">Minimum Acceptable Price (INR)</Label>
                        <Input
                          id="minimumPrice"
                          type="number"
                          placeholder="e.g., 50000"
                    ...
                    {formData.pricingOption === 'auction' && (
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label htmlFor="auctionStartTime" className="text-gray-800 font-medium">Auction Start Time</Label>
                          <Input
                            id="auctionStartTime"
                            type="datetime-local"
                            value={formData.auctionStartTime}
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="auctionEndTime" className="text-gray-800 font-medium">Auction End Time</Label>
                          <Input
                            id="auctionEndTime"
                            type="datetime-local"
                            value={formData.auctionEndTime}
                    ...
                    <div className="space-y-2">
                      <Label className="text-gray-800 font-medium">Logistics & Shipping</Label>
                      <RadioGroup value={formData.logisticsOption} onValueChange={(value: LogisticsOption) => handleSelectChange(value, 'logisticsOption')} className="flex space-x-4">
                        <Label htmlFor="seller-managed" className="flex items-center space-x-2 cursor-pointer text-gray-800 hover:text-gray-900">
                          <RadioGroupItem value="seller-managed" id="seller-managed" className="text-green-500 border-gray-400" />
                          <span>Seller-Managed Shipping</span>
                        </Label>
                        <Label htmlFor="platform-integrated" className="flex items-center space-x-2 cursor-pointer text-gray-800 hover:text-gray-900">
                          <RadioGroupItem value="platform-integrated" id="platform-integrated" className="text-green-500 border-gray-400" />
                          <span>Platform-Integrated Logistics</span>
                        </Label>
                      </RadioGroup>
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="shippingNotes" className="text-gray-800 font-medium">Shipping Notes</Label>
                      <span className='text-green-600 text-sm'>(optional)</span>
                      <Textarea
                        id="shippingNotes"
                        placeholder="e.g., Buyer to arrange pickup, special handling instructions"
                ...
                {currentStep === 4 && (
                  <div className="space-y-6 mt-8">
                    ...
                    <Card className="bg-white border-gray-300 rounded-lg shadow-sm">
                      <CardContent className="p-4 space-y-3">
                        <h4 className="font-semibold text-lg text-gray-900">Item Overview</h4>
                        <p className="text-gray-700">
                          <strong className="text-gray-900">Item Name:</strong> {formData.itemName || 'N/A'}
                        </p>
                        <p className="text-gray-700">
                          <strong className="text-gray-900">Category:</strong> {formData.category || 'N/A'}
                        </p>
                        <p className="text-gray-700">
                          <strong className="text-gray-900">Description:</strong> {formData.description || 'N/A'}
                        </p>
                        <p className="text-gray-700">
                          <strong className="text-gray-900">Condition:</strong> {formData.condition || 'N/A'}
                        </p>
                        <p className="text-gray-700">
                          <strong className="text-gray-900">Quantity:</strong> {formData.quantity ? `${formData.quantity} ${formData.unit}` : 'N/A'}
                        </p>
                    ...
                    <Card className="bg-white border-gray-300 rounded-lg shadow-sm">
                      <CardContent className="p-4 space-y-3">
                        <h4 className="font-semibold text-lg text-gray-900">Pricing & Logistics</h4>
                        <p className="text-gray-700">
                          <strong className="text-gray-900">Pricing Option:</strong> {formatPricingOption(formData.pricingOption)}
                        </p>

                        {formData.pricingOption === 'fixed' && (
                          <p className="text-gray-700">
                            <strong className="text-gray-900">Fixed Price:</strong> ₹{formData.fixedPrice || 'N/A'}
                          </p>
                        )}

                        {formData.pricingOption === 'minimum' && (
                          <p className="text-gray-700">
                            <strong className="text-gray-900">Minimum Price:</strong> ₹{formData.minimumPrice || 'N/A'}
                          </p>
                        )}
                        ...
                        {formData.pricingOption === 'auction' && (
                          <>
                            <p className="text-gray-700">
                              <strong className="text-gray-900">Auction Start:</strong> {formatDateTime(formData.auctionStartTime)}
                            </p>
                            <p className="text-gray-700">
                              <strong className="text-gray-900">Auction End:</strong> {formatDateTime(formData.auctionEndTime)}
                            </p>
                          </>
                        )}

                        <p className="text-gray-700">
                          <strong className="text-gray-900">Logistics:</strong> {formatLogisticsOption(formData.logisticsOption)}
                        </p>
                        <p className="text-gray-700">
                          <strong className="text-gray-900">Shipping Notes:</strong> {formData.shippingNotes || 'N/A'}
                        </p>
                      </CardContent>
                    </Card>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <Label htmlFor="agreePublish" className="text-sm text-gray-700">
                        I confirm all details are accurate and agree to publish this listing.
                      </Label>
                    </div>
